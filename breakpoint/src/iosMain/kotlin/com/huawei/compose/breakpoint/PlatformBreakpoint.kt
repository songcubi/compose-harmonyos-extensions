...
/**
 * iOS fallback implementation - uses LocalWindowInfo for window size
 */
...
/**
 * Create platform-specific breakpoint manager (iOS uses LocalWindowInfo-based fallback)
 */
...
actual fun createBreakpointManager(): PlatformBreakpointManager {
    ...
    LaunchedEffect(windowInfo.containerSize) {
        ...
        manager.updateBreakpoints(widthDp, heightDp)
    }
...
/**
 * iOS implementation - calculates breakpoint based on window size
 */
@Composable
...
/**
 * iOS implementation - calculates height breakpoint based on aspect ratio
 */
@Composable
...
/**
 * iOS implementation - returns current breakpoint state
 */
@Composable
...
/**
 * iOS implementation - subscribes to breakpoint changes
 */
@Composable
